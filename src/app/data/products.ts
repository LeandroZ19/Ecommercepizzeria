...
export const promotions: Promotion[] = [
  ...
  },
  {
    ...
    description: '15% de descuento en toda la carta cada domingo',
    discount: 15,
    image: IMG.comboRapilover,
    validUntil: '2026-12-31',
    code: 'DOMINGO15',
    type: 'daily',
    dayOfWeek: 0,
    details: 'Cada domingo disfruta de 15% de descuento en cualquier pedido. ¡Perfecta para el almuerzo o cena en familia!',
    terms: [
      'Solo domingos',
      'Aplica para todo el menú',
      'Usa el código DOMINGO15',
  ...
  // Temporada
  {
    ...
    description: '20% de descuento en toda la carta durante julio',
    discount: 20,
    image: IMG.promoFamiliarX2,
    validUntil: '2026-07-31',
    code: 'INVIERNO20',
    type: 'seasonal',
    details: 'Celebra el invierno peruano con 20% de descuento en todos los pedidos del mes de julio.',
    terms: [
      'Válido todo julio 2026',
      'Usa el código INVIERNO20',
      'Aplica para todo el menú',
      'No acumulable con otras ofertas',
    ],
  },
  {
    ...
    description: '15% de descuento por el mes patrio',
    discount: 15,
    image: IMG.promoTridenteSupremo,
    validUntil: '2026-07-31',
    code: 'PERU15',
    type: 'seasonal',
    details: '¡Viva el Perú! Celebra Fiestas Patrias con 15% de descuento en cualquier pedido.',
    terms: [
      'Válido del 15 al 31 de julio 2026',
      'Usa el código PERU15',
      'Aplica para todo el menú',
  ...
  },
  {
    id: 'promo-seasonal-3',
    name: 'Promo Escolar',
    description: '10% de descuento en la temporada de regreso a clases',
    discount: 10,
    image: IMG.combo4u,
    validUntil: '2026-08-31',
    code: 'ESCOLAR10',
    type: 'seasonal',
    details: 'Regresa a clases con energía. 10% de descuento durante el mes escolar.',
    terms: [
      'Válido durante agosto 2026',
      'Usa el código ESCOLAR10',
      'Aplica para todo el menú',
      'No acumulable con otras ofertas',
    ],
  },
  {
    id: 'promo-seasonal-4',
    name: 'Noche de Navidad',
    description: '25% de descuento en pedidos navideños',
    discount: 25,
    image: IMG.promoFamiliar,
    validUntil: '2026-12-31',
    code: 'NAVIDAD25',
    type: 'seasonal',
    details: 'Comparte la navidad con toda la familia. 25% de descuento en pedidos de diciembre.',
    terms: [
      'Válido durante diciembre 2026',
      'Usa el código NAVIDAD25',
      'Aplica para pedidos mayores a S/ 50',
      'No acumulable con otras promociones',
    ],
  },
];
